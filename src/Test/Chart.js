...
// cointainer to hold both charts
        ...
        series1.dataFields.value = "notifications";
...
// second chart
        ...
        series2.dataFields.value = "notifications";
        ...
        function handleDragStop(event) {
            ...
            if (targetSlice == slice1) {
                if (targetSlicePoint.x > container.pixelWidth / 2) {
                    ...
                    var animation = slice1.animate([{property: "x", to: series2CenterConverted.x}, {
                        property: "y",
            ...
            if (targetSlice == slice2) {
                if (targetSlicePoint.x < container.pixelWidth / 2) {
                    ...
                    var animation = slice2.animate([{property: "x", to: series1CenterConverted.x}, {
                        property: "y",
